...
!! Last update Time-stamp: <30-oct-2017 11:32:02 carloseduardo>
!
...
!   and read them.
    ...
    write (*,*) 'Enter radius of the sphere in cm.'
...
!   Compute area and volume.  The ** means "raise to a power."
    ...
    area = pi * radius**2
    volume=0.75*pi*radius**3

!   Write the input variables (radius)
!   and output (area and volume) to the screen.
    write(*,*) 'The area and volume for the sphere with radius given, are:'
    write (*,'(1x,a7,f6.2,5x,a7,f6.2,5x,a7,f6.2)') &
